...
(function (VORLON) {
    var InteractiveConsoleDashboard = (function (_super) {
                ...
                _this._interactiveInput.addEventListener("keydown", function (evt) {
                    if (evt.keyCode === 13) {
                        _this.sendCommandToClient('order', {
                            order: _this.isLoggable(_this._interactiveInput.value) ? "console.log(" + _this._interactiveInput.value + ")"
        ...
        InteractiveConsoleDashboard.prototype.isLoggable = function (input) {
            // "val" && 'val
